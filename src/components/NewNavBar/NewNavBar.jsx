    ...
    return (
        <header className="Header">
            <div className="nav-logo">
                ...
                <a href="/main">
                    <h1 className="logo-text" fontSize="80px">
                        hoop'n
                    </h1>
                </a>
            </div>
                ...
                <nav className="Nav">
                    {user ? (
                        <>
                            ...
                            <NavLink
                                onClick={logOutCloseNav}
                                className="button login-btn logout"
                                to="/"
                            >
                                Logout
                            </NavLink>
                        ...
                        <>
                            <NavLink className="button login-btn" to="/login">
                                Log In
                            </NavLink>
                        </>
                    )}
            ...
            {user ? (
                <>
                    <button onClick={toggleNav} className="Burger">
                        <img
                            src="https://i.ibb.co/ZdyrMTz/menu.png"
                            alt="|||"
                            width="50px"
                            height="auto"
                        ></img>
